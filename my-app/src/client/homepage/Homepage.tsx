                        ...
                        <div className={styles.Homepage__postbtn}>
                            ...
                            <div className={styles.Homepage__toolbar}>
                                <ul className={styles.Homepage__list}>
                                    ...
                                    <li><MdOutlineGifBox className={styles.Homepage__item} /></li>
                                ...
                                <button className={styles.Homepage__btn} onClick={handlePostAndUpload}>Post</button>
                            </div>
                        </div>
                    </div>
                    {showPostForm && (
                            ...
                            <div className={`${styles.Homepage__postForm}`}>
                                <div className={styles.Homepage__postbtn}>
                                    ...
                                    <div className={styles.Homepage__toolbar}>
                                        ...
                                        <button className={styles.Homepage__btn} onClick={handlePost}>Post</button>
                                        {/* <Article 
                                          id='123'
                                          name='asd'
                                          userEmail ='sadfwec'    
